...
SECRET_KEY = 'django-insecure-kud2k68re9^t^-6l2vh%zbyr^+9!2@_yih8)pz0&b_ca_$@1%a'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tweet.context_processor.search_form',
            ],
        },
    },
]
...
#else don't set it will automatically goes to logged_out.html template
